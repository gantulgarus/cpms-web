...
import { companies, type Company, type UpdateCompanyRequest } from "@/lib/api";
...
export function EditCompanyDialog({ company }: { company: Company }) {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Компани шинэчлэгдлээ");
      setOpen(false);
    },
    onError: (e: Error) => toast.error(e.message),
  });

  const set = (k: keyof UpdateCompanyRequest) => (e: React.ChangeEvent<HTMLInputElement>) =>
